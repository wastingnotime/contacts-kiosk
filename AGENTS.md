...
Treat every completed change as a commit boundary. Once a deliberate change set is finished, commit it before starting the next change so finished work does not remain unrecorded in the working tree.
